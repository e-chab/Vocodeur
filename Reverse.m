...
if ~exist('C:\Users\yoane\Downloads\projet_obl\figures', 'dir')
	mkdir('C:\Users\yoane\Downloads\projet_obl\figures');
end
t = (0:length(x)-1)/fs;
figure('Color','k');
ax1 = subplot(3,1,1);
...
cb.Color = 'w';
cb.FontSize = 12;
exportgraphics(gcf, 'C:\Users\yoane\Downloads\reverse_pinkfloyd_all.png');
close(gcf);
    
% Suppression des exports doublons : tout est dans la figure principale
